<div class="permisos index">
	...
	<tr<?php echo $class;?>>
		...
		<td class="actions">
			...
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $permiso['Permiso']['id'])); ?>
			<?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $permiso['Permiso']['id']), null, sprintf(__('Are you sure you want to delete # %s?', true), $permiso['Permiso']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
