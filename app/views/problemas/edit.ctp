...
<?php echo $this->Form->create('Problema');?>
	...
	<?php
		...
		echo $this->Form->input('PendienteDe');
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('Problema.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('Problema.id'))); ?></li>
